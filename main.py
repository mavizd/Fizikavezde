...
class MyTabbedPanel(TabbedPanel):
    ...
    def __init__(self, **kwargs):
        ...
        but_test = Button(text='test', size_hint=(None, None), size=(a, b))
        ...
        # tab7
        tab7_button1 = Button(text='Что изучает физика', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button1)
        tab7_button1.bind(on_press=self.on_button_click)  # action on click
        tab7_button2 = Button(text='Некоторые физические термины', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button2)
        tab7_button2.bind(on_press=self.on_button_click)
        tab7_button4 = Button(text='Физические величины и их измерение', size_hint=(None, None), size=(a, b))
        ...
        tab7_button5 = Button(text='Точность и погрешность', size_hint=(None, None), size=(a, b))
        ...
        tab7_button6 = Button(text='Связь физики и техники', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button6)
        tab7_button6.bind(on_press=self.on_button_click)
        tab7_button7 = Button(text='Строение вещества', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button7)
        tab7_button7.bind(on_press=self.on_button_click)
        tab7_button8 = Button(text='Молекулы', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button8)
        tab7_button8.bind(on_press=self.on_button_click)
        tab7_button9 = Button(text='Диффузия', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button9)
        tab7_button9.bind(on_press=self.on_button_click)
        tab7_button10 = Button(text='Взаимное движение молекул', size_hint=(None, None),size=(a, b))
        ...
        tab7_button11 = Button(text='Агрегатные состояния вещества', size_hint=(None, None), size=(a, b))
        ...
        tab7_button13 = Button(text='Механическое движение', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button13)
        tab7_button13.bind(on_press=self.on_button_click)
        tab7_button14 = Button(text='Равномерное и неравномерное движение', size_hint=(None, None), size=(a, b))
        ...
        tab7_button30 = Button(text='Сила трения', size_hint=(None, None), size=(a, b))
        ...
        tab7_button31 = Button(text='Трение покоя', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button31)
        tab7_button31.bind(on_press=self.on_button_click)
        tab7_button32 = Button(text='Трение в природе и технике', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button32)
        tab7_button32.bind(on_press=self.on_button_click)
        tab7_button33 = Button(text='Давление. Единицы давления', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button33)
        tab7_button33.bind(on_press=self.on_button_click)
        tab7_button34 = Button(text='Способы уменьшения и увеличения давления', size_hint=(None, None), size=(a, b))
        ...
        tab7_button35 = Button(text='Давление газа', size_hint=(None, None), size=(a, b))
        ...
        tab7_button37 = Button(text='Давление в жидкости и газе', size_hint=(None, None), size=(a, b))
        ...
        tab7_button39 = Button(text='Сообщающиеся сосуды', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button39)
        tab7_button39.bind(on_press=self.on_button_click)
        tab7_button40 = Button(text='Вес воздуха. Атмосферное давление', size_hint=(None, None), size=(a, b))
        ...
        tab7_button43 = Button(text='Барометр-анероид', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button43)
        tab7_button43.bind(on_press=self.on_button_click)
        tab7_button45 = Button(text='Манометры', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button45)
        tab7_button45.bind(on_press=self.on_button_click)
        tab7_button46 = Button(text='Поршневой жидкостный насос', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button46)
        tab7_button46.bind(on_press=self.on_button_click)
        tab7_button47 = Button(text='Гидравлический пресс', size_hint=(None, None), size=(a, b))
        ...
        tab7_button49 = Button(text='Архимедова сила', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button49)
        tab7_button49.bind(on_press=self.on_button_click)
        tab7_button50 = Button(text='Плавание тел', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button50)
        tab7_button50.bind(on_press=self.on_button_click)
        tab7_button53 = Button(text='Механическая работа. Единицы работы', size_hint=(None, None), size=(a, b))
        ...
        tab7_button54 = Button(text='Мощность. Единицы мощности', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button54)
        tab7_button54.bind(on_press=self.on_button_click)
        tab7_button55 = Button(text='Простые механизмы', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button55)
        tab7_button55.bind(on_press=self.on_button_click)
        tab7_button56 = Button(text='Рычаг. Равновесие сил на рычаге', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button56)
        tab7_button56.bind(on_press=self.on_button_click)
        tab7_button57 = Button(text='Момент силы', size_hint=(None, None), size=(a, b))
        ...
        tab7_button60 = Button(text='Равенство работ при использовании простых механизмов. Золотое правило механики', size_hint=(None, None), size=(a, b))
        ...
        tab7_button62 = Button(text='Энергия', size_hint=(None, None), size=(a, b))
        self.tab7_layout.add_widget(tab7_button62)
        tab7_button62.bind(on_press=self.on_button_click)
        tab7_button63 = Button(text='Потенциальная и кинетическая энергия', size_hint=(None, None), size=(a, b))
        ...
        tab7_button64 = Button(text='Превращение одного вида механической энергии в другой', size_hint=(None, None), size=(a, b))
        ...
        # tab8
        tab8_button1 = Button(text='Тепловое движение. Температура', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button1)
        tab8_button1.bind(on_press=self.on_button_click)
        tab8_button2 = Button(text='Внутренняя энергия', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button2)
        tab8_button2.bind(on_press=self.on_button_click)
        tab8_button3 = Button(text='Способы изменения внутренней энергии тела', size_hint=(None, None), size=(a, b))
        ...
        tab8_button4 = Button(text='Теплопроводность', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button4)
        tab8_button4.bind(on_press=self.on_button_click)
        tab8_button5 = Button(text='Конвекция', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button5)
        tab8_button5.bind(on_press=self.on_button_click)
        tab8_button6 = Button(text='Излучение', size_hint=(None, None), size=(a, b))
        ...
        tab8_button8 = Button(text='Удельная теплоемкость', size_hint=(None, None), size=(a, b))
        ...
        tab8_button12 = Button(text='Агрегатные состояния вещества', size_hint=(None, None), size=(a, b))
        ...
        tab8_button15 = Button(text='Удельная теплота плавления', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button15)
        tab8_button15.bind(on_press=self.on_button_click)
        tab8_button16 = Button(text='Испарение. Насыщенный и ненасыщенный пар', size_hint=(None, None), size=(a, b))
        ...
        tab8_button18 = Button(text='Кипение', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button18)
        tab8_button18.bind(on_press=self.on_button_click)
        tab8_button19 = Button(text='Влажность воздуха. Способы определения влажности воздуха', size_hint=(None, None), size=(a, b))
        ...
        tab8_button21 = Button(text='Работа газа и пара при расширении', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button21)
        tab8_button21.bind(on_press=self.on_button_click)
        tab8_button22 = Button(text='Двигатель внутреннего сгорания', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button22)
        tab8_button22.bind(on_press=self.on_button_click)
        tab8_button24 = Button(text='КПД теплового двигателя', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button24)
        tab8_button24.bind(on_press=self.on_button_click)
        tab8_button25 = Button(text='Электризация тел при соприкосновении', size_hint=(None, None), size=(a, b))
        ...
        tab8_button28 = Button(text='Электрическое поле', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button28)
        tab8_button28.bind(on_press=self.on_button_click)
        tab8_button29 = Button(text='Делимость электрического заряда. Электрон', size_hint=(None, None), size=(a, b))
        ...
        tab8_button30 = Button(text='Строение атомов', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button30)
        tab8_button30.bind(on_press=self.on_button_click)
        tab8_button31 = Button(text='Объяснение электрических явлений', size_hint=(None, None), size=(a, b))
        ...
        tab8_button33 = Button(text='Электрическая цепь и ее составные части', size_hint=(None, None), size=(a, b))
        ...
        tab8_button35 = Button(text='Действия электрического тока', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button35)
        tab8_button35.bind(on_press=self.on_button_click)
        tab8_button36 = Button(text='Направление электрического тока', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button36)
        tab8_button36.bind(on_press=self.on_button_click)
        tab8_button37 = Button(text='Единицы силы тока', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button37)
        tab8_button37.bind(on_press=self.on_button_click)
        tab8_button38 = Button(text='Амперметр. Измерение силы тока', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button38)
        tab8_button38.bind(on_press=self.on_button_click)
        tab8_button39 = Button(text='Электрическое напряжение', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button39)
        tab8_button39.bind(on_press=self.on_button_click)
        tab8_button40 = Button(text='Единицы напряжения', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button40)
        tab8_button40.bind(on_press=self.on_button_click)
        tab8_button41 = Button(text='Вольтметр. Измерение напряжения', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button41)
        tab8_button41.bind(on_press=self.on_button_click)
        tab8_button42 = Button(text='Зависимость силы тока от напряжения', size_hint=(None, None), size=(a, b))
        ...
        tab8_button44 = Button(text='Закон Ома для участка цепи', size_hint=(None, None), size=(a, b))
        ...
        tab8_button47 = Button(text='Реостаты', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button47)
        tab8_button47.bind(on_press=self.on_button_click)
        tab8_button48 = Button(text='Последовательное соединение проводников', size_hint=(None, None), size=(a, b))
        ...
        tab8_button49 = Button(text='Параллельное соединение проводников', size_hint=(None, None), size=(a, b))
        ...
        tab8_button50 = Button(text='Работа электрического тока', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button50)
        tab8_button50.bind(on_press=self.on_button_click)
        tab8_button51 = Button(text='Мощность электрического тока', size_hint=(None, None), size=(a, b))
        ...
        tab8_button55 = Button(text='Короткое замыкание. Предохранители', size_hint=(None, None), size=(a, b))
        ...
        tab8_button56 = Button(text='Магнитное поле', size_hint=(None, None), size=(a, b))
        ...
        tab8_button59 = Button(text='Постоянные магниты. Магнитное поле постоянных магнитов', size_hint=(None, None), size=(a, b))
        ...
        tab8_button60 = Button(text='Магнитное поле Земли', size_hint=(None, None), size=(a, b))
        ...
        tab8_button62 = Button(text='Источники света. Распространение света', size_hint=(None, None), size=(a, b))
        ...
        tab8_button63 = Button(text='Отражение света. Закон отражения света', size_hint=(None, None), size=(a, b))
        ...
        tab8_button64 = Button(text='Плоское зеркало', size_hint=(None, None), size=(a, b))
        ...
        tab8_button66 = Button(text='Линзы. Оптическая сила линзы', size_hint=(None, None), size=(a, b))
        self.tab8_layout.add_widget(tab8_button66)
        tab8_button66.bind(on_press=self.on_button_click)

        # tab9
        tab9_button1 = Button(text='Материальная точка. Система отсчёта', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button1)
        tab9_button1.bind(on_press=self.on_button_click)
        tab9_button2 = Button(text='Перемещение', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button2)
        tab9_button2.bind(on_press=self.on_button_click)
        tab9_button3 = Button(text='Определение координаты движущегося тела', size_hint=(None, None), size=(a, b))
        ...
        tab9_button11 = Button(text='Второй закон Ньютона', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button11)
        tab9_button11.bind(on_press=self.on_button_click)
        tab9_button12 = Button(text='Третий закон Ньютона', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button12)
        tab9_button12.bind(on_press=self.on_button_click)
        tab9_button13 = Button(text='Свободное падение тел', size_hint=(None, None), size=(a, b))
        ...
        tab9_button15 = Button(text='Закон всемирного тяготения', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button15)
        tab9_button15.bind(on_press=self.on_button_click)
        tab9_button18 = Button(text='Прямолинейное и криволинейное движение', size_hint=(None, None), size=(a, b))
        ...
        tab9_button21 = Button(text='Импульс тела', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button21)
        tab9_button21.bind(on_press=self.on_button_click)
        tab9_button22 = Button(text='Закон сохранения импульса', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button22)
        tab9_button22.bind(on_press=self.on_button_click)
        tab9_button23 = Button(text='Реактивное движение. Ракеты', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button23)
        tab9_button23.bind(on_press=self.on_button_click)
        tab9_button24 = Button(text='Колебательное движение', size_hint=(None, None), size=(a, b))
        ...
        tab9_button27 = Button(text='Гармонические колебания', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button27)
        tab9_button27.bind(on_press=self.on_button_click)
        tab9_button28 = Button(text='Затухающие колебания', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button28)
        tab9_button28.bind(on_press=self.on_button_click)
        tab9_button29 = Button(text='Вынужденные колебания', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button29)
        tab9_button29.bind(on_press=self.on_button_click)
        tab9_button30 = Button(text='Резонанс', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button30)
        tab9_button30.bind(on_press=self.on_button_click)
        tab9_button31 = Button(text='Распространение колебаний в среде. Волны', size_hint=(None, None), size=(a, b))
        ...
        tab9_button32 = Button(text='Продольные и поперечные волны', size_hint=(None, None), size=(a, b))
        ...
        tab9_button34 = Button(text='Источники звука. Звуковые колебания', size_hint=(None, None), size=(a, b))
        ...
        tab9_button35 = Button(text='Высота и тембр звука', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button35)
        tab9_button35.bind(on_press=self.on_button_click)
        tab9_button36 = Button(text='Громкость звука', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button36)
        tab9_button36.bind(on_press=self.on_button_click)
        tab9_button37 = Button(text='Распространение звука', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button37)
        tab9_button37.bind(on_press=self.on_button_click)
        tab9_button38 = Button(text='Звуковые волны. Скорость звука', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button38)
        tab9_button38.bind(on_press=self.on_button_click)
        tab9_button39 = Button(text='Отражение звука. Эхо', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button39)
        tab9_button39.bind(on_press=self.on_button_click)
        tab9_button41 = Button(text='Ультразвук и инфразвук', size_hint=(None, None), size=(a, b))
        ...
        tab9_button46 = Button(text='Обнаружение магнитного поля по его действию на электрический ток. Правило левой руки',size_hint=(None, None), size=(a, b))
        ...
        tab9_button47 = Button(text='Индукция магнитного поля', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button47)
        tab9_button47.bind(on_press=self.on_button_click)
        tab9_button48 = Button(text='Магнитный поток', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button48)
        tab9_button48.bind(on_press=self.on_button_click)
        tab9_button49 = Button(text='Явление электромагнитной индукции', size_hint=(None, None), size=(a, b))
        ...
        tab9_button50 = Button(text='Получение переменного электрического тока', size_hint=(None, None), size=(a, b))
        ...
        tab9_button51 = Button(text='Электромагнитное поле', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button51)
        tab9_button51.bind(on_press=self.on_button_click)
        tab9_button52 = Button(text='Электромагнитные волны', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button52)
        tab9_button52.bind(on_press=self.on_button_click)
        tab9_button53 = Button(text='Интерференция света', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button53)
        tab9_button53.bind(on_press=self.on_button_click)
        tab9_button54 = Button(text='Электромагнитная природа света', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button54)
        tab9_button54.bind(on_press=self.on_button_click)
        tab9_button56 = Button(text='Модели атомов. Опыт Резерфорда', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button56)
        tab9_button56.bind(on_press=self.on_button_click)
        tab9_button57 = Button(text='Радиоактивные превращения атомных ядер', size_hint=(None, None), size=(a, b))
        ...
        tab9_button62 = Button(text='Изотопы', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button62)
        tab9_button62.bind(on_press=self.on_button_click)
        tab9_button63 = Button(text='Альфа- и бета-распад. Правило смещения', size_hint=(None, None), size=(a, b))
        ...
        tab9_button64 = Button(text='Ядерные силы', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button64)
        tab9_button64.bind(on_press=self.on_button_click)
        tab9_button65 = Button(text='Энергия связи. Дефект масс', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button65)
        tab9_button65.bind(on_press=self.on_button_click)
        tab9_button67 = Button(text='Цепная реакция', size_hint=(None, None), size=(a, b))
        ...
        tab9_button69 = Button(text='Атомная энергетика', size_hint=(None, None), size=(a, b))
        ...
        tab9_button72 = Button(text='Термоядерная реакция', size_hint=(None, None), size=(a, b))
        self.tab9_layout.add_widget(tab9_button72)
        tab9_button72.bind(on_press=self.on_button_click)

        # tab10
        tab10_button2 = Button(text='Способы описания движения', size_hint=(None, None), size=(a, b))
        ...
        tab10_button6 = Button(text='Сложение скоростей', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button6)
        tab10_button6.bind(on_press=self.on_button_click)
        tab10_button8 = Button(text='Мгновенная и средняя скорости', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button8)
        tab10_button8.bind(on_press=self.on_button_click)
        tab10_button9 = Button(text='Ускорение', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button9)
        tab10_button9.bind(on_press=self.on_button_click)
        tab10_button10 = Button(text='Движение с постоянным ускорением', size_hint=(None, None), size=(a, b))
        ...
        tab10_button15 = Button(text='Равномерное движение точки по окружности', size_hint=(None, None), size=(a, b))
        ...
        tab10_button16 = Button(text='Кинематика абсолютно твёрдого тела', size_hint=(None, None), size=(a, b))
        ...
        tab10_button18 = Button(text='Основное утверждение механики', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button18)
        tab10_button18.bind(on_press=self.on_button_click)
        tab10_button19 = Button(text='Сила. Масса. Единица массы', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button19)
        tab10_button19.bind(on_press=self.on_button_click)
        tab10_button20 = Button(text='Первый закон Ньютона', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button20)
        tab10_button20.bind(on_press=self.on_button_click)
        tab10_button21 = Button(text='Второй закон Ньютона', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button21)
        tab10_button21.bind(on_press=self.on_button_click)
        tab10_button22 = Button(text='Принцип суперпозиции сил', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button22)
        tab10_button22.bind(on_press=self.on_button_click)
        tab10_button24 = Button(text='Третий закон Ньютона', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button24)
        tab10_button24.bind(on_press=self.on_button_click)
        tab10_button25 = Button(text='Геоцентрическая система отсчёта', size_hint=(None, None), size=(a, b))
        ...
        tab10_button27 = Button(text='Силы в природе', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button27)
        tab10_button27.bind(on_press=self.on_button_click)
        tab10_button28 = Button(text='Сила тяжести и сила всемирного тяготения', size_hint=(None, None), size=(a, b))
        ...
        tab10_button29 = Button(text='Сила тяжести на других планетах', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button29)
        tab10_button29.bind(on_press=self.on_button_click)
        tab10_button31 = Button(text='Первая космическая скорость', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button31)
        tab10_button31.bind(on_press=self.on_button_click)
        tab10_button33 = Button(text='Вес. Невесомость', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button33)
        tab10_button33.bind(on_press=self.on_button_click)
        tab10_button34 = Button(text='Деформация и силы упругости. Закое Гука', size_hint=(None, None), size=(a, b))
        ...
        tab10_button36 = Button(text='Силы трения', size_hint=(None, None), size=(a, b))
        ...
        tab10_button40 = Button(text='Механическая работа и мощность силы', size_hint=(None, None), size=(a, b))
        ...
        tab10_button41 = Button(text='Энергия. Кинетическая энергия', size_hint=(None, None), size=(a, b))
        ...
        tab10_button44 = Button(text='Потенциальная энергия', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button44)
        tab10_button44.bind(on_press=self.on_button_click)
        tab10_button45 = Button(text='Закон сохранения энергии в механике', size_hint=(None, None), size=(a, b))
        ...
        tab10_button51 = Button(text='Равновесие тел', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button51)
        tab10_button51.bind(on_press=self.on_button_click)
        tab10_button52 = Button(text='Молекулярная физика.Тепловые явления', size_hint=(None, None), size=(a, b))
        ...
        tab10_button55 = Button(text='Броуновское движение', size_hint=(None, None), size=(a, b))
        ...
        tab10_button59 = Button(text='Температура и тепловое равновесие', size_hint=(None, None), size=(a, b))
        ...
        tab10_button61 = Button(text='Измерение скоростей молекул газа', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button61)
        tab10_button61.bind(on_press=self.on_button_click)
        tab10_button63 = Button(text='Уравнение состояния идеального газа', size_hint=(None, None), size=(a, b))
        ...
        tab10_button78 = Button(text='Первый закон термодинамики', size_hint=(None, None), size=(a, b))
        ...
        tab10_button81 = Button(text='Второй закон термодинамики', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button81)
        tab10_button81.bind(on_press=self.on_button_click)
        tab10_button83 = Button(text='Основы электродинамики', size_hint=(None, None), size=(a, b))
        ...
        tab10_button88 = Button(text='Электрическое поле', size_hint=(None, None), size=(a, b))
        ...
        tab10_button98 = Button(text='Энергия заряженного конденсатора.Применение конденсаторов', size_hint=(None, None), size=(a, b))
        ...
        tab10_button100 = Button(text='Электрический ток. Сила тока', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button100)
        tab10_button100.bind(on_press=self.on_button_click)
        tab10_button105 = Button(text='Электродвижущая сила', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button105)
        tab10_button105.bind(on_press=self.on_button_click)
        tab10_button106 = Button(text='Закон Ома для полной цепи', size_hint=(None, None), size=(a, b))
        ...
        tab10_button115 = Button(text='Плазма', size_hint=(None, None), size=(a, b))
        self.tab10_layout.add_widget(tab10_button115)
        tab10_button115.bind(on_press=self.on_button_click)

        # tab11
        tab11_button1 = Button(text='Взаимодействие токов', size_hint=(None, None), size=(a, b))
        ...
        tab11_button6 = Button(text='Сила Лоренца', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button6)
        tab11_button6.bind(on_press=self.on_button_click)
        tab11_button7 = Button(text='Магнитные свойства вещества', size_hint=(None, None), size=(a, b))
        ...
        tab11_button11 = Button(text='Закон электромагнитной индукции', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button11)
        tab11_button11.bind(on_press=self.on_button_click)
        tab11_button12 = Button(text='Вихревое электрическое поле', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button12)
        tab11_button12.bind(on_press=self.on_button_click)
        tab11_button13 = Button(text='ЭДМ индукциив движущихся проводниках', size_hint=(None, None), size=(a, b))
        ...
        tab11_button14 = Button(text='Электродинамический микрофон', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button14)
        tab11_button14.bind(on_press=self.on_button_click)
        tab11_button15 = Button(text='Самоиндукция. Индуктивность', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button15)
        tab11_button15.bind(on_press=self.on_button_click)
        tab11_button16 = Button(text='Энергия магнитногополя тока', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button16)
        tab11_button16.bind(on_press=self.on_button_click)
        tab11_button17 = Button(text='Электромагнитное поле', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button17)
        tab11_button17.bind(on_press=self.on_button_click)
        tab11_button18 = Button(text='Свободные и вынужденные колебания', size_hint=(None, None), size=(a, b))
        ...
        tab11_button20 = Button(text='Математический маятник', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button20)
        tab11_button20.bind(on_press=self.on_button_click)
        tab11_button21 = Button(text='Динамика колебательного движения', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button21)
        tab11_button21.bind(on_press=self.on_button_click)
        tab11_button22 = Button(text='Гармонические колебания', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button22)
        tab11_button22.bind(on_press=self.on_button_click)
        tab11_button24 = Button(text='Свободные и вынужденные колебания', size_hint=(None, None), size=(a, b))
        ...
        tab11_button25 = Button(text='Вынужденные колебания. Резонанс', size_hint=(None, None), size=(a, b))
        ...
        tab11_button31 = Button(text='Переменный электрический ток', size_hint=(None, None), size=(a, b))
        ...
        tab11_button33 = Button(text='Конденсатор в цепи переменного тока', size_hint=(None, None), size=(a, b))
        ...
        tab11_button35 = Button(text='Резонанс в электрической цепи', size_hint=(None, None), size=(a, b))
        ...
        tab11_button36 = Button(text='Генератор на транзисторе. Автоколебания', size_hint=(None, None), size=(a, b))
        ...
        tab11_button38 = Button(text='Трансформаторы', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button38)
        tab11_button38.bind(on_press=self.on_button_click)
        tab11_button40 = Button(text='Передача электроэнергии', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button40)
        tab11_button40.bind(on_press=self.on_button_click)
        tab11_button42 = Button(text='Волновые явления', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button42)
        tab11_button42.bind(on_press=self.on_button_click)
        tab11_button44 = Button(text='Длина волны. Скорость волны', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button44)
        tab11_button44.bind(on_press=self.on_button_click)
        tab11_button45 = Button(text='Уравнение гармонической бегущей волны', size_hint=(None, None), size=(a, b))
        ...
        tab11_button46 = Button(text='Распространение волн в упругих средах', size_hint=(None, None), size=(a, b))
        ...
        tab11_button47 = Button(text='Звуковые волны', size_hint=(None, None), size=(a, b))
        ...
        tab11_button48 = Button(text='Что такое электромагнитная волна', size_hint=(None, None), size=(a, b))
        ...
        tab11_button61 = Button(text='Закон преломления света', size_hint=(None, None), size=(a, b))
        ...
        tab11_button62 = Button(text='Полное отражение', size_hint=(None, None), size=(a, b))
        ...
        tab11_button66 = Button(text='Дисперсия света', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button66)
        tab11_button66.bind(on_press=self.on_button_click)
        tab11_button67 = Button(text='Интерференция механический волн', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button67)
        tab11_button67.bind(on_press=self.on_button_click)
        tab11_button68 = Button(text='Интерференция света', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button68)
        tab11_button68.bind(on_press=self.on_button_click)
        tab11_button70 = Button(text='Дифракция механических волн', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button70)
        tab11_button70.bind(on_press=self.on_button_click)
        tab11_button71 = Button(text='Дифракция света', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button71)
        tab11_button71.bind(on_press=self.on_button_click)
        tab11_button73 = Button(text='Поперечность световых волн', size_hint=(None, None), size=(a, b))
        ...
        tab11_button77 = Button(text='Относительность одновременности', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button77)
        tab11_button77.bind(on_press=self.on_button_click)
        tab11_button79 = Button(text='Элементы релятивистской динамики', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button79)
        tab11_button79.bind(on_press=self.on_button_click)
        tab11_button80 = Button(text='Виды излучений. Источники света', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button80)
        tab11_button80.bind(on_press=self.on_button_click)
        tab11_button81 = Button(text='Спектры и спектральные аппараты', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button81)
        tab11_button81.bind(on_press=self.on_button_click)
        tab11_button82 = Button(text='Виды спектров', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button82)
        tab11_button82.bind(on_press=self.on_button_click)
        tab11_button83 = Button(text='Спектральный анализ', size_hint=(None, None), size=(a, b))
        ...
        tab11_button96 = Button(text='Лазеры', size_hint=(None, None), size=(a, b))
        ...
        tab11_button98 = Button(text='Открытие радиоактивности', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button98)
        tab11_button98.bind(on_press=self.on_button_click)
        tab11_button99 = Button(text='Альфа-, Бета- и Гамма-излучения', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button99)
        tab11_button99.bind(on_press=self.on_button_click)
        tab11_button100 = Button(text='Радиоактивные превращения', size_hint=(None, None), size=(a, b))
        ...
        tab11_button102 = Button(text='Изотопы', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button102)
        tab11_button102.bind(on_press=self.on_button_click)
        tab11_button103 = Button(text='Открытие нейрона', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button103)
        tab11_button103.bind(on_press=self.on_button_click)
        tab11_button104 = Button(text='Строение атомного ядра. Ядерные силы', size_hint=(None, None), size=(a, b))
        ...
        tab11_button113 = Button(text='Биологическое действие радиоактивных излучений', size_hint=(None, None), size=(a, b))
        ...
        tab11_button114 = Button(text='Три этапа в развитии физики элементарных частиц', size_hint=(None, None), size=(a, b))
        ...
        tab11_button115 = Button(text='Открытие позитрона. Античастицы', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button115)
        tab11_button115.bind(on_press=self.on_button_click)
        tab11_button116 = Button(text='Видимые движения небесных тел', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button116)
        tab11_button116.bind(on_press=self.on_button_click)
        tab11_button117 = Button(text='Законы движения планет', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button117)
        tab11_button117.bind(on_press=self.on_button_click)
        tab11_button118 = Button(text='Система Земля-Луна', size_hint=(None, None), size=(a, b))
        ...
        tab11_button120 = Button(text='Солнце', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button120)
        tab11_button120.bind(on_press=self.on_button_click)
        tab11_button121 = Button(text='Основные характеристики звезд', size_hint=(None, None), size=(a, b))
        ...
        tab11_button124 = Button(text='Млечный путь  наша Галактика', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button124)
        tab11_button124.bind(on_press=self.on_button_click)
        tab11_button125 = Button(text='Галактики', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button125)
        tab11_button125.bind(on_press=self.on_button_click)
        tab11_button126 = Button(text='Строение и эволюция Вселенной', size_hint=(None, None), size=(a, b))
        self.tab11_layout.add_widget(tab11_button126)
        tab11_button126.bind(on_press=self.on_button_click)
        tab11_button127 = Button(text='Единая физическая картина мира', size_hint=(None, None), size=(a, b))
    ...
    def update_search_results(self, instance, text):
        ...
        if text:  # if user input some text
            ...
            [self.button_names7.append(Button(text=result, size_hint=(None, None), size=(a, b))) for result in
             results_7]
            [self.button_names8.append(Button(text=result, size_hint=(None, None), size=(a, b))) for result in
             results_8]
            [self.button_names9.append(Button(text=result, size_hint=(None, None), size=(a, b))) for result in
             results_9]
            [self.button_names10.append(Button(text=result, size_hint=(None, None), size=(a, b))) for result in
             results_10]
            [self.button_names11.append(Button(text=result, size_hint=(None, None), size=(a, b))) for result in
             results_11]
